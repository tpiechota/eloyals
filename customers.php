                        ...
                        <div id="faq-accordion" class="accordion">
                            <div class="accordion-group">
                                <div class="accordion-heading">
                                    <a class="accordion-toggle"><strong>Customers</strong></a>
                                    <p class="cusRet">Through the eLoyals customer portal, customers can sign up on for the service; join businesses that have already signed up for the eLoyals System, request a physical card, and check the balance of each loyalty card. A mobile web application would be available for customers who own a smartphone, which would allow them to use a virtual card instead of the physical one. With the possession of the physical and/or virtual card, customers are able to start collecting their stamps / points / credits in any eLoyals participating store.<br/>&nbsp;</p>
                                </div>
                            </div>
                        </div>
                    </div>
